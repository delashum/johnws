    ...
    return (function e(t, n, r) {
                            ...
                            if ((range != null) && _this.quill.getLength() > 0) {
                                if (range.start !== range.end) {
                                    ...
                                    if (hotkey.key === dom.KEYS.BACKSPACE) {
                                        ref = _this.quill.editor.doc.findLineAt(range.start), line = ref[0], offset = ref[1];
                                        if (offset === 0 && (line.formats.bullet || line.formats.list || line.formats.code)) {
                                            format = line.formats.bullet ? 'bullet' : (line.formats.list ? 'list' : 'code');
        ...
        27: [function (_dereq_, module, exports) {
            ...
            Toolbar = (function () {
                ...
                Toolbar.prototype._applyFormat = function (format, range, value) {
                    ...
                    return _.defer((function (_this) {
                        return function () {
                            _this.updateActive(range, ['bullet', 'list', 'code']);
        ...
        30: [function (_dereq_, module, exports) {
            ...
            Quill = (function (superClass) {
                ...
                Quill.DEFAULTS = {
                    formats: ['align', 'bold', 'italic', 'strike', 'underline', 'color', 'background', 'font', 'size', 'link', 'image', 'bullet', 'list', 'code'],
                    modules: {
                        'keyboard': true,
                        'paste-manager': true,
                        'undo-manager': true
